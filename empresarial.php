...
<div class="content-wrapper">
              ...
              <div class="col-12">
                <div class="callout callout-info" style="border-bottom: solid 1px #008080;">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-2">
                      <form action="corte_empresarial.php" method="POST" target="_blank">
                    ...
                    <div class="col-sm-2">
                      <button type="submit" class="btn btn-success"><i class="fas fa-print"></i> CORTE EMPRESARIAL</button>
                    </div>
  ...
  <div class="content" id="listar_reporte_ventas">
    ...
    <div class="header" style="padding:7px;">
      <div class="row mb-2">
          <div class="col-sm-9">
            <h2 class="card-title" align="right" style="text-align:right;"><i class="far fa-file-alt" style="color:green"></i><strong style="text-transform: uppercase;"> REPORTE GENERAL DE VENTAS EMPRESARIALES -- <?php echo $_SESSION["sucursal_usuario"];?></strong></h2>
          </div>
          <div class="col-sm-3">
            <div>
